 ...
 *
 */
public class TuneCbowSelf {


	protected static final Logger logger = LoggerFactory.getLogger(TuneCbowSelf.class);
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		tlm_w2v_skipgram.initialiseW2V_atquerytime(args[1]);
		...
		for(int i = 0; i<muvalues.length;i++) {
			...
			PrintWriter pt_w2v_skipgram = new PrintWriter(new File("var/results/res_dir_w2v_cbow_self_" + String.valueOf(mu) + ".res"));
			...
			while (querySource.hasNext()) {
				...
				TRECoutput_w2v_skipgram.printResults(pt_w2v_skipgram, rq_w2v, "dir_w2v_cbow_self", "Q0", 1000);
