 ...
 *
 */
public class TuneSkipGram {


	protected static final Logger logger = LoggerFactory.getLogger(TuneSkipGram.class);
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		//double [ ]  muvalues = {100.0, 200.0, 300.0, 500.0};
		...
		for(int i = 0; i<muvalues.length;i++) {
			...
			PrintWriter pt_w2v_skipgram = new PrintWriter(new File("var/results/res_dir_mu_" + String.valueOf(mu) + ".res"));
