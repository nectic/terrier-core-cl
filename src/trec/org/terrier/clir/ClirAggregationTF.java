 ...
 *
 */
public class ClirAggregationTF {


	protected static final Logger logger = LoggerFactory.getLogger(ClirAggregationTF.class);
	...
	public void processQueries() throws IOException, InterruptedException {
		...
		PrintWriter pt_w2v_skipgram = new PrintWriter(new File("var/results/res_clir_aggregation_tf.res"));
		...
		while (querySource.hasNext()) {
			...
			rq_w2v = tlm_w2v_skipgram.runMatching(rq_w2v, "clir_aggregation_tf", "dir");
			TRECoutput_w2v_skipgram.printResults(pt_w2v_skipgram, rq_w2v, "clir_aggregation_tf", "Q0", 1000);
